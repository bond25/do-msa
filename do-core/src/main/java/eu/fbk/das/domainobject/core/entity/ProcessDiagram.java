...
import eu.fbk.das.domainobject.core.exceptions.InvalidFlowCurrentStateException;
import eu.fbk.das.domainobject.core.exceptions.InvalidFlowInitialStateException;
...
public class ProcessDiagram {
    ...
    private static Logger LOG = LoggerFactory.getLogger(ProcessDiagram.class);
    ...
    @XmlElements({
            @XmlElement(name = "switch", type = SwitchActivity.class, namespace = "http://docs.oasis-open.org/wsbpel/2.0/process/executable"),
            @XmlElement(name = "reply", type = ReplyActivity.class, namespace = "http://docs.oasis-open.org/wsbpel/2.0/process/executable"),
            @XmlElement(name = "invoke", type = InvokeActivty.class, namespace = "http://docs.oasis-open.org/wsbpel/2.0/process/executable"),
            @XmlElement(name = "pick", type = PickActivity.class, namespace = "http://docs.oasis-open.org/wsbpel/2.0/process/executable"),
...
//            eu.fbk.das.process.eu.fbk.das.engine.engine.api.jaxb.scenario.Scenario.DomainObject.DomainObjectInstance d) {
